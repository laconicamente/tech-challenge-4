...
export const WidgetFinancialStatus = () => {
    const { balanceValue, isLoadingBalance } = useTransactionManager();
    ...
    if (balanceValue === 0 && !isLoadingBalance) return (<View style={{ paddingTop: 5 }}>
            {isLoadingBalance ? (<LoadingSkeleton />) :
